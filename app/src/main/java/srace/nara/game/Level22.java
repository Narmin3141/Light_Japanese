...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texdescriptionEnd_1.setText(R.string.check_your_knowledge_22);
...
//Кнопка "Назад" - конец
        ...
        final int[] texts = {
               R.id.random_text1, R.id.random_text2, R.id.random_text3,R.id.random_text4,
                R.id.random_text5,R.id.random_text6, R.id.random_text7,
        };
        for(int i=0;i<7;i++){TextView tv = findViewById(texts[i]);
            tv.setText(array.texts22[i]);}
        //подключение анимации - начало
        final Animation a = AnimationUtils.loadAnimation(Level22.this, R.anim.alpha_1);
        //подключение анимации - конец
        //генерация чисел - начало
        num1 = random.nextInt(7); num2 = random.nextInt(7);
        while (num1 == num2) {num2 = random.nextInt(7);} num3 = random.nextInt(7);
        while ((num1 == num3) || (num2 == num3)){num3 = random.nextInt(7);}
        num4 = random.nextInt(7);
        while ((num1 == num4) || (num2 == num4) || (num3 == num4)){num4 = random.nextInt(7);}
        num5 = random.nextInt(7);
        while ((num1 == num5) || (num2 == num5) || (num3 == num5)||(num4 == num5))
        {num5 = random.nextInt(7);} num6 = random.nextInt(7);
        while ((num1 == num6) || (num2 == num6) || (num3 == num6) || (num4 == num6) || (num5 == num6))
        {num6 = random.nextInt(7);}
        num7 = random.nextInt(7);
        while ((num1 == num7) || (num2 == num7) || (num3 == num7) || (num4 == num7) || (num5 == num7)|| (num6 == num7))
        {num7 = random.nextInt(7);}

        //генерация чисел - конец
        img1_line4.setImageResource(array.images22[num1]);
        //img2_line4.setImageResource(array.images17[num2]);
        img3_line4.setImageResource(array.images22[num2]);
        img4_line4.setImageResource(array.images22[num3]);
        img1_line5.setImageResource(array.images22[num4]);
        img2_line5.setImageResource(array.images22[num5]);
        img1_line6.setImageResource(array.images22[num6]);
        //img2_line6.setImageResource(array.images16[num5]);
        //img3_line6.setImageResource(array.images16[num6]);
        img4_line6.setImageResource(array.images22[num7]);

        //обработка нажатия на первую кнопку - начало
        img1_line4.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    if /*((range == 0) && */(num1==range) {
                        img1_line4.setBackgroundResource(R.drawable.style_points_green);
                        ...
                        if (count == 5) {text_points.setText(R.string.point5);} if (count == 6) {text_points.setText(R.string.point6);}
                        if (count==7) {text_points.setText(R.string.point7);
                        ...
                        dialogEnd.show();}
                    } else {img1_line4.setBackgroundResource(R.drawable.style_red);
...
//обработка нажатия на вторую кнопку - конец
        ...
        img4_line4.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    if/*((range == 2) && */(num3==range) {
                        img4_line4.setBackgroundResource(R.drawable.style_points_green);
                        range+=1; count+=1;
                        if (count == 1) {text_points.setText(R.string.point1);} if (count == 2) {text_points.setText(R.string.point2);}
                        if (count == 3) {text_points.setText(R.string.point3);} if (count == 4) {text_points.setText(R.string.point4);}
                        if (count == 5) {text_points.setText(R.string.point5);} if (count == 6) {text_points.setText(R.string.point6);}
                    ...
                    else { img4_line4.setBackgroundResource(R.drawable.style_red);
                        textdescriptionEnd.setText(R.string.error);
                        //Кнопка Продолжить - начадо
                        Button btncontinuoe2 = (Button) dialogEnd.findViewById(R.id.buttoncontinuoe);
                        btncontinuoe2.setOnClickListener(new View.OnClickListener() {
...
//обработка нажатия на пятую кнопку - конец
        ...
        img1_line6.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    if/*((range == 5) && */(num6==range) {
                        img1_line6.setBackgroundResource(R.drawable.style_points_green);
                        range+=1; count+=1;
                        if (count == 1) {text_points.setText(R.string.point1);} if (count == 2) {text_points.setText(R.string.point2);}
                        if (count == 3) {text_points.setText(R.string.point3);} if (count == 4) {text_points.setText(R.string.point4);}
                        if (count == 5) {text_points.setText(R.string.point5);} if (count == 6) {text_points.setText(R.string.point6);}
                    ...
                    else {img1_line6.setBackgroundResource(R.drawable.style_red);
                        textdescriptionEnd.setText(R.string.error);
                        //Кнопка Продолжить - начадо
                        Button btncontinuoe2 = (Button) dialogEnd.findViewById(R.id.buttoncontinuoe);
                        btncontinuoe2.setOnClickListener(new View.OnClickListener() {
...
//обработка нажатия на третью шестую - конец
        //обработка нажатия на шестую кнопку - начало
        img4_line6.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    if/*((range == 5) && */(num7==range) {
                        img4_line6.setBackgroundResource(R.drawable.style_points_green);
                        range+=1; count+=1;
                        if (count == 1) {text_points.setText(R.string.point1);} if (count == 2) {text_points.setText(R.string.point2);}
                        if (count == 3) {text_points.setText(R.string.point3);} if (count == 4) {text_points.setText(R.string.point4);}
                        if (count == 5) {text_points.setText(R.string.point5);} if (count == 6) {text_points.setText(R.string.point6);}
                    ...
                    else {img4_line6.setBackgroundResource(R.drawable.style_red);
                        textdescriptionEnd.setText(R.string.error);
                        //Кнопка Продолжить - начадо
                        Button btncontinuoe2 = (Button) dialogEnd.findViewById(R.id.buttoncontinuoe);
                        btncontinuoe2.setOnClickListener(new View.OnClickListener() {
