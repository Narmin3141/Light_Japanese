...
public class Level28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texdescriptionEnd_1.setText(R.string.check_your_knowledge_28);
...
//Кнопка "Назад" - конец
        ...
        for(int i=0;i<4;i++){TextView tv = findViewById(texts[i]);
            tv.setText(array.texts28[i]);}
        //подключение анимации - начало
        final Animation a = AnimationUtils.loadAnimation(Level28.this, R.anim.alpha_1);
        ...
        img2_line4.setImageResource(array.images28[num1]);img2_line4.startAnimation(a);
        img3_line4.setImageResource(array.images28[num2]);
        ...
        img2_line6.setImageResource(array.images28[num3]);
        img3_line6.setImageResource(array.images28[num4]);
