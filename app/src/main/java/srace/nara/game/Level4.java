...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<10;i++){
            ...
            imageView.setImageResource(array.images4[i]);
        }
        for(int i=0;i<10;i++){
            TextView textView = dialog.findViewById(previewtext[i]);
            textView.setText(array.texts4[i]);
        }
...
//Кнопка "Назад" - конец
        ...
        final Animation a = AnimationUtils.loadAnimation(Level4.this,R.anim.alpha_1);
        ...
        //чтобы числа не повторялись
        img_right.setImageResource(array.images4[numRight]);//достаём картинку для правой картинки
        ...
        random_text.setText(array.texts4[numText]);
