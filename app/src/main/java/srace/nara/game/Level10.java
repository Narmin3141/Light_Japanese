...
//Кнопка "Назад" - конец
        ...
        for(int i=0;i<4;i++){TextView tv = findViewById(texts[i]);
            tv.setText(array.texts10[i]);}
        //подключение анимации - начало
        final Animation a = AnimationUtils.loadAnimation(Level10.this, R.anim.alpha_1);
        ...
        img2_line4.setImageResource(array.images10[num1]);img2_line4.startAnimation(a);
        img3_line4.setImageResource(array.images10[num2]);
        ...
        img2_line6.setImageResource(array.images10[num3]);
        img3_line6.setImageResource(array.images10[num4]);
